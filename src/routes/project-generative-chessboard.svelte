<svelte:head>
	...
	<title>Project | Generative Chessboard</title>
</svelte:head>

<section class="work">
	<h1 data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">Project Generative Chessboard</h1>
	...
	<article class="the-project">
		...
		<div class="work-images">
			<img src="/img-correspondent.png" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" data-aos-once="true" alt="Correspondent website project about equallity">
		</div>
	</article>
