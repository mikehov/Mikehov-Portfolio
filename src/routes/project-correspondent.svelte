...
import ProjectAwarenessCampaign from "./project-awareness-campaign.svelte";
...
<svelte:head>
	...
	<title>Project | Correspondent</title>
</svelte:head>

<section class="work">
	<h1 data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">Project Correspondent</h1>
